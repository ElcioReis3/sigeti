...
class Permission
{
  ...
  public const VIEW_MY_TICKETS = "ver_meus_chamados";
    ...
    public const ATTACH_FILE_TICKET = "anexar_aquivo_chamado";
    ...
    public const VIEW_TICKET_HISORY = "ver_historico_chamado";
    ...
    public const VIEW_TECHNICAL_DASHBOARD = "ver_dashboard_tecnico";
    ...
    public const TOGGER_USER_STATUS = "ativar_inativar_usuario";
