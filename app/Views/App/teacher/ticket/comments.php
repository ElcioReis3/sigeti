<?= $this->layout('teacher/app', [
        "title" => $title ?? "Solicitante | Comentários - " . APP_NAME,
        "menuActive" => "chamados",
        "submenuActive" => "todos",
]) ?>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="col-12 col-md-6 mb-3">
                                            <div class="d-flex align-items-center gap-3 p-3 border rounded">
                                                ...
                                                <div class="d-flex gap-1 flex-shrink-0">
                                                    <a href="<?= url('/professor/chamados/' . $ticket->getId() . '/anexos/download/' . $attachment->getId()) ?>"
                                                       class="btn btn-sm btn-outline-primary"
                                                       title="Baixar">
                                                        <i class="bi bi-download"></i>
                                                    </a>
                                                    <?php if ($attachment->getUploadedBy() === $loggedUserId): ?>
                                                        <button type="button"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="<?= url('/professor/chamados/' . $ticket->getId() . '/anexos/excluir/' . $attachment->getId()) ?>"
                            ...
                            <?php if (count($attachments ?? []) < TICKET_MAX_ATTACHMENTS): ?>
                                <form action="<?= url('/professor/chamados/' . $ticket->getId() . '/anexos') ?>"
                                      method="post"
