                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= url('/tecnico/usuarios/editar/' . $user->getId()) ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="role" id="role" class="form-select" required>
                                                    <option value="professor" <?= $user->getRole() === \App\Models\User::TEACH ? 'selected' : '' ?>>
                                                        Professor
                                                    </option>
                                                    <option value="tecnico" <?= $user->getRole() === \App\Models\User::TECHNICAL ? 'selected' : '' ?>>
                                                        Técnico
                                                    </option>
                                                </select>
                                            </div>
                                ...
                                <!-- Bloco Escola + Turno -->
                                <div id="schoolLinks"
                                     style="display: <?= $user->getRole() === \App\Models\User::TEACH ? 'block' : 'none' ?>;">
                                    <hr>
                                                    ...
                                                    <div class="col-12 <?= $index > 0 ? 'col-md-4' : 'col-md-5' ?> mb-2 mb-md-0">
                                                        <div class="input-group">
                                                            ...
                                                            <select name="schools[<?= $index ?>][shift]"
                                                                ...
                                                                <option value="integral" <?= $link->getShift() === \App\Models\SchoolUser::FULLDAY ? 'selected' : '' ?>>
                                                                    Integral
                                                                </option>
                                                            </select>
                                                        </div>
